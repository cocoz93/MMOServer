...
#
# logical size x DSF4 = final resolution (Pretendard embedded):
#   all cards : 1200x640 -> 4800x2560
$dir = $PSScriptRoot
...
$render = Join-Path $env:TEMP "ig-render-db"
...
Render "00_cover"           1200 640 "00_cover.png"
Render "01_why_async"       1200 640 "01_why_async.png"
Render "02_structure"       1200 640 "02_structure.png"
Render "03_failure_policy"  1200 640 "03_failure_policy.png"
Render "04_prepared_stmt"   1200 640 "04_prepared_stmt.png"
Render "05_resilience"      1200 640 "05_resilience.png"

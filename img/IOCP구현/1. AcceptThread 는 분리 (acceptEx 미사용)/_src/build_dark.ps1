# 다크·프리미엄 톤 시안 렌더링 (McKinsey / Keynote / Stripe 다크 버전)
# 1600x900 logical x DSF3 = 4800x2700 최종
# Usage:  powershell -ExecutionPolicy Bypass -File build_styles_dark.ps1
...
Render "dark_matrix" 1600 900 "dark_matrix.png"
Render "dark_hero"   1600 900 "dark_hero.png"
Render "dark_flow"   1600 900 "dark_flow.png"

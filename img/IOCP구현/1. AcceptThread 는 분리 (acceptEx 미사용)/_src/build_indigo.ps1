# 3가지 디자인 스타일 시안 렌더링 (McKinsey / Keynote / Stripe)
# 1600x900 logical x DSF3 = 4800x2700 최종 (PPT/노션 삽입용 고해상)
# Usage:  powershell -ExecutionPolicy Bypass -File build_styles.ps1
...
# 저장소 폴더명의 한글/공백/괄호가 chrome.exe 인자로 넘어가면 깨짐 -> ASCII 임시 폴더에 스테이징
...
Render "indigo_matrix" 1600 900 "indigo_matrix.png"
Render "indigo_hero"   1600 900 "indigo_hero.png"
Render "indigo_flow"   1600 900 "indigo_flow.png"

# AcceptThread PPT 덱 렌더링 (하우스 톤, 4슬라이드)
# 표지 → 핵심주장 → 처리구조 → 의사결정
...
$stageRoot = Join-Path $env:TEMP "mmo-deck-stage"
...
Render "deck_02_claim"     1600 900
Render "deck_03_structure" 1600 900
Render "deck_04_decision"  1600 900

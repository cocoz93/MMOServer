# Rebuild infographic PNGs from HTML sources (folder 10 — SendThread 증설 K3).
...
$targets = @(
  ...
  @{ n = "02_diagnosis";  w = 1200; h = 700 },
  @{ n = "03_ksweep";     w = 1200; h = 700 },
  @{ n = "04_ceiling";    w = 1200; h = 700 },
  @{ n = "05_conclusion"; w = 1200; h = 700 }
)

$render = Join-Path $env:TEMP "ig-f10"
